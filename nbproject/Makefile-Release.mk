...
${OBJECTDIR}/Aprovacao.o: Aprovacao.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Aprovacao.o Aprovacao.c
...
${OBJECTDIR}/CodigoPostal.o: CodigoPostal.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CodigoPostal.o CodigoPostal.c

${OBJECTDIR}/Coordenadas.o: Coordenadas.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Coordenadas.o Coordenadas.c
...
${OBJECTDIR}/FuncoesGerais.o: FuncoesGerais.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncoesGerais.o FuncoesGerais.c

${OBJECTDIR}/InfoMorada.o: InfoMorada.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InfoMorada.o InfoMorada.c
...
${OBJECTDIR}/Menu_adicionar_admin.o: Menu_adicionar_admin.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_adicionar_admin.o Menu_adicionar_admin.c

${OBJECTDIR}/Menu_admin.o: Menu_admin.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_admin.o Menu_admin.c

${OBJECTDIR}/Menu_alterar_admin.o: Menu_alterar_admin.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_alterar_admin.o Menu_alterar_admin.c

${OBJECTDIR}/Menu_cliente.o: Menu_cliente.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_cliente.o Menu_cliente.c

${OBJECTDIR}/Menu_eliminar_admin.o: Menu_eliminar_admin.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_eliminar_admin.o Menu_eliminar_admin.c

${OBJECTDIR}/Menu_funcionario_aprovar.o: Menu_funcionario_aprovar.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_funcionario_aprovar.o Menu_funcionario_aprovar.c

${OBJECTDIR}/Menu_funcionario_entrega.o: Menu_funcionario_entrega.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_funcionario_entrega.o Menu_funcionario_entrega.c

${OBJECTDIR}/Menu_listar_admin.o: Menu_listar_admin.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_listar_admin.o Menu_listar_admin.c

${OBJECTDIR}/Menu_login.o: Menu_login.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menu_login.o Menu_login.c

${OBJECTDIR}/Pesquisa.o: Pesquisa.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pesquisa.o Pesquisa.c
...
${OBJECTDIR}/Produto_Encomenda.o: Produto_Encomenda.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Produto_Encomenda.o Produto_Encomenda.c
